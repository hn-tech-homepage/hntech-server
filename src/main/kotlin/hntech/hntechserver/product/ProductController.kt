...
class ProductController(private val productService: ProductService) {
     ...
     */
    @GetMapping
    fun getAllProducts(@RequestParam(name = "category", required = false) categoryName: String?
    ): List<ProductResponseForm>
    = productService.getAllProducts(categoryName).map { convertDto(it) }
